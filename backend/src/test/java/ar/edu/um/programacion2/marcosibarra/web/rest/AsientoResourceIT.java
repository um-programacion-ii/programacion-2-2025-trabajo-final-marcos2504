...
class AsientoResourceIT {
    ...
    private static final Instant DEFAULT_BLOQUEADO_HASTA = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_BLOQUEADO_HASTA = Instant.now().truncatedTo(ChronoUnit.MILLIS);
