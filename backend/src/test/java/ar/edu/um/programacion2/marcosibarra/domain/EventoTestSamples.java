...
public class EventoTestSamples {
    ...
    public static Evento getEventoSample1() {
        return new Evento().id(1L).titulo("titulo1").resumen("resumen1").direccion("direccion1").filaAsientos(1).columnaAsientos(1);
    }

    public static Evento getEventoSample2() {
        return new Evento().id(2L).titulo("titulo2").resumen("resumen2").direccion("direccion2").filaAsientos(2).columnaAsientos(2);
    }
