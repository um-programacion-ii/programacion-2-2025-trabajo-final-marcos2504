...
import ar.edu.um.programacion2.marcosibarra.service.IntegranteService;
...
/**
 * REST controller for managing {@link ar.edu.um.programacion2.marcosibarra.domain.Integrante}.
 */
@RestController
...
public class IntegranteResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<IntegranteDTO>> getAllIntegrantes(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get a page of Integrantes");
        Page<IntegranteDTO> page = integranteService.findAll(pageable);
