...
import ar.edu.um.programacion2.marcosibarra.service.EventoTipoService;
...
/**
 * REST controller for managing {@link ar.edu.um.programacion2.marcosibarra.domain.EventoTipo}.
 */
@RestController
...
public class EventoTipoResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<EventoTipoDTO>> getAllEventoTipos(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get a page of EventoTipos");
        Page<EventoTipoDTO> page = eventoTipoService.findAll(pageable);
