...
import ar.edu.um.programacion2.marcosibarra.service.AsientoService;
...
/**
 * REST controller for managing {@link ar.edu.um.programacion2.marcosibarra.domain.Asiento}.
 */
@RestController
...
public class AsientoResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<AsientoDTO>> getAllAsientos(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get a page of Asientos");
        Page<AsientoDTO> page = asientoService.findAll(pageable);
