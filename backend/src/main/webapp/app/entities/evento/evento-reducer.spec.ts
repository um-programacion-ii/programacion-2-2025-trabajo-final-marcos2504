...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './evento.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EVENTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EVENTO actions', async () => {
      const arg = { id: 12252 };
    ...
    it('dispatches UPDATE_EVENTO actions', async () => {
      const arg = { id: 12252 };
    ...
    it('dispatches PARTIAL_UPDATE_EVENTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EVENTO actions', async () => {
      const arg = 42666;
