...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTOTIPO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EVENTOTIPO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EVENTOTIPO actions', async () => {
      const arg = { id: 2293 };
    ...
    it('dispatches UPDATE_EVENTOTIPO actions', async () => {
      const arg = { id: 2293 };
    ...
    it('dispatches PARTIAL_UPDATE_EVENTOTIPO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EVENTOTIPO actions', async () => {
      const arg = 42666;
