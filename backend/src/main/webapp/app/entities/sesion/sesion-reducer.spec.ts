...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './sesion.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SESION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SESION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SESION actions', async () => {
      const arg = { id: 14634 };
    ...
    it('dispatches UPDATE_SESION actions', async () => {
      const arg = { id: 14634 };
    ...
    it('dispatches PARTIAL_UPDATE_SESION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SESION actions', async () => {
      const arg = 42666;
