...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTEGRANTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INTEGRANTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INTEGRANTE actions', async () => {
      const arg = { id: 22585 };
    ...
    it('dispatches UPDATE_INTEGRANTE actions', async () => {
      const arg = { id: 22585 };
    ...
    it('dispatches PARTIAL_UPDATE_INTEGRANTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INTEGRANTE actions', async () => {
      const arg = 42666;
